...
WebMock.disable_net_connect!(
  ...
  allow: [
    %r{api.notifications.service.gov.uk/v2/notifications/email},
    %r{objects.githubusercontent.com/github-production-*},
...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    ...
    temp_generated_metadata_json_files.each do |dir|
      FileUtils.rm_rf(dir)
    end
  end
