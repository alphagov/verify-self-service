...
RSpec.describe 'Check your certificate page', type: :system do
  ...
  it 'shows check your ceritifcate page for msa signing and successfully goes to next page' do
  ...
  it 'shows check your ceritifcate page for sp signing and successfully goes to next page' do
